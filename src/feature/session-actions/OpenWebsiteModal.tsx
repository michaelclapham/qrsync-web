...
export class OpenWebsiteModal extends SessionActionModal<
  {},
  { urlInput: string }
> {
  state = {
    ...
    return (
      <>
        ...
        <IonInput
          ...
          placeholder="Enter URL to open on other computers"
          onIonChange={(e) => this.setState({ urlInput: e.detail.value! })}
        ></IonInput>
