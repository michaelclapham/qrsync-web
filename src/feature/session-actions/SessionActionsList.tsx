...
export class SessionActionsList extends React.Component<
  SessionActionsListProps,
  SessionActionsListState
> {
  ...
  render() {
    ...
    return (
      <div className="session-actions">
        ...
        {sessionActions
          .filter(
            (action) => this.props.userIsSessionOwner || !action.ownerOnly
          )
  ...
  onActionClicked = (action: SessionActionSummary) => {
    if (action.name === "Open Website") {
      this.setState({
        ...
        actionModalComponent: action.modalComponent,
      });
    }
  };
}
